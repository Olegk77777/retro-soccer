...
SLEEVE = [
    ...
    (0.160, 0.101, 1.483),
    (0.250, 0.089, 1.472),
    (0.345, 0.079, 1.462),   # манжета
    (0.360, 0.074, 1.460),   # подворот манжеты внутрь
]
SLEEVE_N = 8
...
ARM = [
    ...
    (0.400, 0.056, 1.463),
    (0.470, 0.050, 1.459),
    (0.512, 0.048, 1.458),   # локоть
    (0.575, 0.052, 1.455),   # брюшко предплечья
    (0.700, 0.044, 1.451),
    (0.836, 0.034, 1.446),   # запястье
]
ARM_N = 8
...
HAND = [
    (0.836, 0.038, 0.032, 0.000),
    (0.872, 0.052, 0.036, -0.005),   # ладонь шире запястья
    (0.908, 0.052, 0.035, -0.007),
    (0.934, 0.045, 0.029, -0.009),
    (0.950, 0.028, 0.018, -0.010),   # кончики пальцев
]
HAND_N = 8
# Большой палец: короткий прилив на передней стороне ладони.
THUMB = dict(x0=0.850, x1=0.886, dy=-0.050, dz=-0.004, r0=0.019, r1=0.014, n=6)

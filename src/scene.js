...
function createPitchTexture() {
  ...
  const paint = () => {
    ...
    if (drawWearBase()) {
      // Собственный контраст ТРАВЫ — до полос, света и разметки, чтобы
      // тронуть только сам газон (правило с 28.07.2026, фидбек Олега «газон
      // раньше был не так равномерно освещён, это давало больший объём»).
      //
